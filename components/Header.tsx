...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full py-5 px-26 flex justify-between items-center backdrop-blur-md bg-black/40 border-b border-white/10">
      <div className="text-sky-400 font-mono font-bold text-lg tracking-tight">
        &lt;<span className="text-white">aleor25</span>/&gt;
      </div>

      <div className="flex items-center gap-5">
        <nav className="bg-neutral-900/80 border border-white/10 rounded-2xl px-2.5 py-2 backdrop-blur-md shadow-lg">
