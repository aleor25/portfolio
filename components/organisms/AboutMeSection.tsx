            ...
            <div className="flex flex-col-reverse md:flex-row items-stretch justify-between gap-10 lg:gap-14">
                <div className="flex-1 flex flex-col justify-between items-start">
                    <div className="mb-8 w-full max-w-2xl">
                        <h1 className="text-6xl font-bold mb-4 text-white tracking-tight">{t('profile.name')}</h1>
                        <p className="text-3xl text-sky-400 whitespace-pre-line mb-6 font-semibold">{t('profile.role')}</p>
                        <p className="text-gray-400 text-lg leading-relaxed">{t('profile.description')}</p>
                    </div>
                            ...
                            <div className="relative flex items-center">
                                ...
                                >
                                    ...
                                    {copied ? (
                                        ...
                                        <span className="w-5 h-5 flex items-center justify-center text-gray-400 group-hover:text-white transition-colors [&>svg]:w-full [&>svg]:h-full">
                                            {TECH.copy.icon}
                                        </span>
                                    )}
                                </button>
                ...
                <div className="shrink-0 flex items-center justify-center">
                    <div className="relative w-64 h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-3xl overflow-hidden border-2 border-white/10 p-1.5 bg-neutral-900/60 shadow-2xl">
