        ...
        <article className="w-full mx-auto mb-24 last:mb-0">
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center">
                    <h3 className="text-4xl font-extrabold text-neutral-900 dark:text-white mb-5 tracking-tight">{translatedTitle}</h3>

                    <p className="text-lg text-neutral-600 dark:text-gray-400 leading-relaxed mb-8">{translatedDescription}</p>
